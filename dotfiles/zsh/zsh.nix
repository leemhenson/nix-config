pkgs: {
  ...
  sessionVariables = {
    ...
    PATH = "./node_modules/.bin:$HOME/.config/vscode/wrapper:$HOME/.config/vscode-insiders/wrapper:$HOME/.local/bin:$PATH:/opt/homebrew/bin:$HOME/Library/Android/sdk/platform-tools";
  };
